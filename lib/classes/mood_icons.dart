...
const List<MoodIcons> _moodIconsList = const <MoodIcons>[
  ...
  const MoodIcons(title: 'Dissatified', color: Colors.cyan, rotation: -0.2, icon: Icons.sentiment_dissatisfied),
  const MoodIcons(title: 'Very Dissatified', color: Colors.red, rotation: -0.4, icon: Icons.sentiment_very_dissatisfied),
];